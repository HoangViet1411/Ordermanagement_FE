...
const authAdmin = [authenticateToken, requirePermission(['admin'])];
const authAdminWithParams = [authenticateToken, requirePermission(['admin']), validateParams(idParamSchema)];
