...
// Whitelist các fields được phép select cho User (security)
...
// Whitelist các fields được phép select cho Product (security)
 ...
 * @param whitelist - Set các fields được phép (default: USER_FIELD_WHITELIST)
 * @returns Array of field names hoặc undefined (để Sequelize SELECT *)
 */
export function buildAttributes(fields?: string, whitelist: Set<string> = USER_FIELD_WHITELIST): string[] | undefined {
...
/**
 * Build attributes array cho Product từ query string fields
 * @param fields - Comma-separated string: "id,name,price"
 * @returns Array of field names hoặc undefined (để Sequelize SELECT *)
 */
export function buildProductAttributes(fields?: string): string[] | undefined {
